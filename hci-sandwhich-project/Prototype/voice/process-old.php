<?php
require __DIR__.'/vendor/autoload.php'; // match automatico tra il servizio richiesto e il giorsto elemneto in Vendor
...
if(isset($_POST['submit'])) {
    ...
    try {
        ...
        if($displayName == "Orders_status") {
            ...
            $obj->ID = $parameters["number"];
            $obj->stuffing = $parameters["status"];

            printf('Here make a sql request for: %s ' . PHP_EOL, $displayName);
        }
